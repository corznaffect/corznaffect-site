...
const IMG = {
  ...
  eggs: 'https://images.pexels.com/photos/34871729/pexels-photo-34871729.jpeg?w=600&q=80',
  ...
  burger: 'https://images.pexels.com/photos/7828570/pexels-photo-7828570.jpeg?w=600&q=80',
  ...
  jerky: 'https://images.pexels.com/photos/5237010/pexels-photo-5237010.jpeg?w=600&q=80',
  ...
  kombu: 'https://images.pexels.com/photos/8802312/pexels-photo-8802312.jpeg?w=600&q=80',
};
...
const MEALS = [
  ...
  { id: 'l8', name: 'Turkey & Avo Burger', cat: 'lunch', img: IMG.burger, cal: 590, p: 44, c: 48, f: 22, cookMins: 15, tags: [], scale: true, ing: [['Coles Turkey Mince', 150, 'g'], ['Coles Brioche Bun', 1, 'piece'], ['Avocado', 60, 'g'], ['Cos Lettuce', 30, 'g'], ['Tomato', 50, 'g'], ['Praise Light Mayo', 10, 'g'], ['Bega Tasty Cheese', 20, 'g']], steps: ['Form turkey mince into a patty, season with salt, pepper and garlic powder.', 'Cook in a hot pan 4 min each side until 75C internal. Rest 2 min.', 'Toast brioche bun cut-side down for 1 min.', 'Build: bun base, mayo, lettuce, patty, cheese, tomato, mashed avocado, top bun.'] },
  ...
  { id: 's1', name: 'Protein Bar & Apple', cat: 'snacks', img: IMG.protbar, cal: 280, p: 22, c: 38, f: 6, cookMins: 1, tags: ['vego', 'bulk', 'maintain'], scale: false, ing: [['Quest Protein Bar', 60, 'g'], ['Pink Lady Apple', 1, 'medium']], steps: ['Grab a Quest bar from the pantry.', 'Wash and slice the apple if preferred.', 'Eat together for sustained energy.'] },
  ...
  { id: 'dr10', name: 'Kombucha on Ice', cat: 'drinks', img: IMG.kombu, cal: 60, p: 0, c: 14, f: 0, cookMins: 1, tags: ['vego', 'gf', 'df', 'cut', 'maintain'], scale: false, ing: [['Remedy Kombucha (any flavour)', 330, 'ml']], steps: ['Pour kombucha over a glass of ice.', 'Garnish with a slice of lemon if desired.', 'Drink fresh from the bottle for best probiotics.'] },
];
