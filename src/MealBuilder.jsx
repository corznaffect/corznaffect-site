...
const IMG = {
  ...
  toast: 'https://images.unsplash.com/photo-1588137378633-dea1336ce1e2?w=600&q=80',
...
const MEALS = [
  ...
  { id: 's9', name: 'Beef Jerky & Cheese', cat: 'snacks', img: IMG.jerky, cal: 260, p: 28, c: 6, f: 14, cookMins: 1, tags: ['gf', 'cut', 'maintain'], scale: false, ing: [["Jack Link's Beef Jerky", 40, 'g'], ['Bega Stringers Cheese', 30, 'g']], steps: ['Open jerky pack.', 'Pair with cheese stick.', 'Great high-protein, low-carb on-the-go option.'] },
