...
const PHASES = {
  ...
  unsure: { id: 'unsure', label: 'Not Sure Yet', subtitle: 'Corey will assign your phase on your call', range: 'To be confirmed', scale: 1.0, mealRange: 'All meals shown', snackRange: 'All snacks shown', drinkRange: 'All drinks shown', icon: HelpCircle, defaultGoals: { cal: 2400, p: 170, c: 260, f: 80 } },
};

const IMG = {
  oats: 'https://images.unsplash.com/photo-1563213349-0775a114f170?w=600&q=80',
  yog: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&q=80',
  eggs: 'https://images.pexels.com/photos/34871730/pexels-photo-34871730.jpeg?w=600&q=80',
  toast: 'https://images.pexels.com/photos/7936660/pexels-photo-7936660.jpeg?w=600&q=80',
  smooth: 'https://images.pexels.com/photos/4051764/pexels-photo-4051764.jpeg?w=600&q=80',
  pancake: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=600&q=80',
  burrito: 'https://images.unsplash.com/photo-1711488735428-27c6757beb5c?w=600&q=80',
  acai: 'https://images.unsplash.com/photo-1490474418585-ba9bad8fd0ea?w=600&q=80',
  granola: 'https://images.unsplash.com/photo-1568086256437-e745ec321426?w=600&q=80',
  shaksh: 'https://images.unsplash.com/photo-1590412200988-a436970781fa?w=600&q=80',
  chicrice: 'https://images.pexels.com/photos/5836780/pexels-photo-5836780.jpeg?w=600&q=80',
  tuna: 'https://images.unsplash.com/photo-1676300186691-39edceddd705?w=600&q=80',
  beef: 'https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=600&q=80',
  hallo: 'https://images.pexels.com/photos/25315522/pexels-photo-25315522.jpeg?w=600&q=80',
  caesar: 'https://images.unsplash.com/photo-1666819615040-eff5e52c778a?w=600&q=80',
  poke: 'https://images.unsplash.com/photo-1633862472152-e3873eb1b3ff?w=600&q=80',
  steaksal: 'https://images.unsplash.com/photo-1605851086486-2bfb45e926d9?w=600&q=80',
  burger: 'https://images.pexels.com/photos/33750224/pexels-photo-33750224.jpeg?w=600&q=80',
  pasta: 'https://images.pexels.com/photos/2697229/pexels-photo-2697229.jpeg?w=600&q=80',
  buddha: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&q=80',
  salmon: 'https://images.unsplash.com/photo-1678269367737-eb7f31f720f8?w=600&q=80',
  spag: 'https://images.pexels.com/photos/4349774/pexels-photo-4349774.jpeg?w=600&q=80',
  stirfry: 'https://images.pexels.com/photos/6718707/pexels-photo-6718707.jpeg?w=600&q=80',
  lamb: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&q=80',
  curry: 'https://images.unsplash.com/photo-1582576163090-09d3b6f8a969?w=600&q=80',
  steak: 'https://images.unsplash.com/photo-1676300185292-e23bb3db50fa?w=600&q=80',
  ...
  protbar: 'https://images.unsplash.com/photo-1698653140026-e0e692cfbca0?w=600&q=80',
  cottage: 'https://images.pexels.com/photos/9788607/pexels-photo-9788607.jpeg?w=600&q=80',
  beggs: 'https://images.pexels.com/photos/36583480/pexels-photo-36583480.jpeg?w=600&q=80',
  yogh: 'https://images.unsplash.com/photo-1696540246756-a31640c30e61?w=600&q=80',
  trail: 'https://images.pexels.com/photos/6928273/pexels-photo-6928273.jpeg?w=600&q=80',
  hummus: 'https://images.pexels.com/photos/34644302/pexels-photo-34644302.jpeg?w=600&q=80',
  ricecake: 'https://images.pexels.com/photos/16797806/pexels-photo-16797806.jpeg?w=600&q=80',
  banpb: 'https://images.pexels.com/photos/10420416/pexels-photo-10420416.jpeg?w=600&q=80',
  jerky: 'https://images.pexels.com/photos/13111782/pexels-photo-13111782.jpeg?w=600&q=80',
  edam: 'https://images.pexels.com/photos/1860193/pexels-photo-1860193.jpeg?w=600&q=80',
  coffee: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=600&q=80',
  massg: 'https://images.pexels.com/photos/556832/pexels-photo-556832.jpeg?w=600&q=80',
  ...
  matcha: 'https://images.unsplash.com/photo-1717603545560-28f9da83ecc3?w=600&q=80',
...
const Logo = ({ size = 200 }) => {
  ...
  return <div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: `${fontSize}px`, letterSpacing: `${fontSize * 0.35}px`, color: G, fontWeight: 600, textTransform: 'uppercase', display: 'inline-block', paddingLeft: `${fontSize * 0.35}px` }}>CORZNAFFECT</div>;
};

const LogoMark = ({ size = 60 }) => {
  const fontSize = Math.max(10, Math.round(size * 0.22));
  return <div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: `${fontSize}px`, letterSpacing: `${fontSize * 0.3}px`, color: G, fontWeight: 700, textTransform: 'uppercase', display: 'inline-block', paddingLeft: `${fontSize * 0.3}px` }}>CORZNAFFECT</div>;
};

const SHARED_CSS = `@import url('https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,300;9..144,400;9..144,500;9..144,600&family=DM+Sans:wght@400;500;600;700&display=swap'); * { box-sizing: border-box; } body { margin: 0; } input:focus,textarea:focus { outline: none; border-color: ${G} !important; } button:not(:disabled):hover { transform: translateY(-1px); } button { transition: all 0.2s ease; } .mc { transition: all 0.2s ease; position: relative; } .mc:hover { transform: translateY(-3px); box-shadow: 0 12px 28px rgba(10,10,10,0.08); border-color: ${G} !important; } .mc img { transition: transform 0.4s ease; } .mc:hover img { transform: scale(1.05); } .ing-tooltip { display: none; position: absolute; top: 0; left: 0; right: 0; bottom: 0; z-index: 50; background: rgba(10,10,10,0.93); padding: 14px 16px; pointer-events: none; overflow: hidden; } .mc:hover .ing-tooltip { display: block; } @media print { .np { display: none !important; } body { background: white !important; } }`;
...
export default function MealBuilder() {
  ...
  const [macrosUnknown, setMacrosUnknown] = useState(false);
  ...
  useEffect(() => {
    if (code) {
      try {
        ...
        if (s.macrosUnknown) { setMacrosUnknown(true); setGoalsSet(true); }
  ...
  useEffect(() => {
    if (code) { try { localStorage.setItem(`cz_${code}`, JSON.stringify({ phase, goals: goalsSet ? goals : null, macrosUnknown, plan, reviews })); } catch (e) {} }
  }, [code, phase, goals, goalsSet, macrosUnknown, plan, reviews]);

  const scaled = useMemo(() => {
    if (!phase || phase === 'unsure') return MEALS;
  ...
  const phaseMeals = useMemo(() => (phase && phase !== 'unsure') ? scaled.filter(m => m.scale || m.tags.includes(phase)) : scaled, [scaled, phase]);
  ...
  const stat = (cur, goal, tol = 0.05) => { if (!goal || macrosUnknown) return 'n'; const d = (cur - goal) / goal; if (Math.abs(d) <= tol) return 'on'; return d > tol ? 'over' : 'under'; };
  ...
  const onTrack = !macrosUnknown && sCal === 'on' && sP === 'on' && sC === 'on' && sF === 'on';
  ...
  const subGoals = () => { const g = { cal: +tg.cal, p: +tg.p, c: +tg.c, f: +tg.f }; if (g.cal && g.p && g.c && g.f) { setGoals(g); setMacrosUnknown(false); setGoalsSet(true); } };
  const skipMacros = () => { setMacrosUnknown(true); setGoalsSet(true); };
  ...
  const visible = useMemo(() => phaseMeals.filter(m => m.cat === tab).filter(m => filters.length === 0 || filters.every(f => m.tags.includes(f))).filter(m => cookFilter === null || m.cookMins <= cookFilter), [tab, filters, cookFilter, phaseMeals]);
  ...
  if (!phase) return (
    <div style={page}>
      <style>{SHARED_CSS}</style>
      <div style={{ ...wrap, padding: '48px 20px', maxWidth: 1040 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <p style={{ ...BF, fontSize: 15, color: '#5A5A5A', margin: 0, lineHeight: 1.6, maxWidth: 540, marginLeft: 'auto', marginRight: 'auto' }}>Your phase determines portion sizes, meal options, and shopping list quantities. Pick what your coach has assigned — or select "Not Sure Yet" if you haven't had your call.</p>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20 }}>
          {Object.values(PHASES).map(p => {
            const Ic = p.icon;
            const isUnsure = p.id === 'unsure';
            return (
              <button key={p.id} onClick={() => setPhase(p.id)} style={{ ...BF, textAlign: 'left', padding: '32px 28px', background: isUnsure ? '#F5F5F0' : '#FFF', border: isUnsure ? '1px dashed #C0B898' : '1px solid #D4CFBF', cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: 14, position: 'relative', overflow: 'hidden' }} className="pc">
                ...
                <Ic size={32} color={isUnsure ? '#9A9A9A' : G} strokeWidth={1.4} />
                <div>
                  <div style={{ ...SF, fontSize: 26, fontWeight: 400, fontStyle: 'italic', letterSpacing: '-0.02em', marginBottom: 4, color: isUnsure ? '#5A5A5A' : K }}>{p.label}</div>
                  <div style={{ fontSize: 13, color: '#7A7A7A', lineHeight: 1.5, marginBottom: 12 }}>{p.subtitle}</div>
                  <div style={{ fontSize: 11, letterSpacing: '1.5px', textTransform: 'uppercase', color: isUnsure ? '#9A9A9A' : G, fontWeight: 700 }}>{p.range}</div>
                </div>
                {!isUnsure && (
                ...
                {isUnsure && (
                  <div style={{ marginTop: 4, paddingTop: 14, borderTop: '1px dashed #D4CFBF', fontSize: 12, color: '#7A7A7A', lineHeight: 1.6 }}>
                    All meals available to explore. Your phase and macros will be confirmed by Corey on your 1:1 call.
                  </div>
                )}
              </button>
            );
    ...
    <div style={page}>
      ...
      <div style={{ ...wrap, padding: '48px 20px', maxWidth: 600 }}>
        ...
        <div style={{ background: '#FFF', padding: '44px 40px', border: `1px solid ${LINE}`, position: 'relative', overflow: 'hidden' }}>
          ...
          <p style={{ ...BF, fontSize: 14, color: '#5A5A5A', margin: '0 0 28px', lineHeight: 1.6 }}>Enter the macros your coach has given you. If you haven't had your call yet, use the option below.</p>
          ...
          <div style={{ marginTop: 20, padding: '18px 20px', background: BG, border: `1px solid ${LINE}`, borderLeft: `3px solid ${G}` }}>
            <div style={{ ...BF, fontSize: 12, color: '#5A5A5A', lineHeight: 1.6, marginBottom: 12 }}><strong style={{ color: K }}>Haven't had your call yet?</strong> No worries — Corey will go through your exact macros on your 1:1. You can still browse and save meals you like now.</div>
            <button onClick={skipMacros} style={{ ...BF, width: '100%', padding: 12, fontSize: 12, fontWeight: 700, letterSpacing: '1.5px', textTransform: 'uppercase', background: 'transparent', color: K, border: `1px solid ${K}`, cursor: 'pointer' }}>I don't know my macros yet — continue anyway</button>
          </div>
        </div>
      </div>
    </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 14, marginBottom: 40 }}>
            {[['Calories', totals.cal, goals.cal, ''], ['Protein', totals.p, goals.p, 'g'], ['Carbs', totals.c, goals.c, 'g'], ['Fats', totals.f, goals.f, 'g']].map(([l, v, gg, u]) => (
              <div key={l} style={{ background: BG, padding: '18px 20px', borderLeft: `3px solid ${G}` }}>
                ...
                {macrosUnknown ? <div style={{ ...BF, fontSize: 11, color: '#9A9A9A', marginTop: 4, fontStyle: 'italic' }}>Target: TBC on call</div> : <div style={{ ...BF, fontSize: 11, color: '#5A5A5A', marginTop: 4 }}>Target: {gg}{u}</div>}
              </div>
            ))}
          </div>
          ...
          {planMeals.map(m => (
            <div key={m.id} style={{ marginBottom: 32, paddingBottom: 32, borderBottom: `1px solid ${LINE}`, breakInside: 'avoid' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: 14, flexWrap: 'wrap', gap: 8 }}>
                <h3 style={{ fontSize: 22, fontWeight: 400, margin: 0, letterSpacing: '-0.01em', fontStyle: 'italic' }}>{m.name}{m.qty > 1 && <span style={{ ...BF, fontSize: 13, color: G, marginLeft: 12, fontStyle: 'normal', fontWeight: 700 }}>x{m.qty}</span>}</h3>
                <div style={{ ...BF, fontSize: 12, color: '#5A5A5A' }}>{m.cal} cal · {m.p}g protein · {m.c}g carbs · {m.f}g fat per serve</div>
              </div>
    ...
    <div style={page}>
        ...
        <div style={{ ...wrap, padding: '14px 20px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, flexWrap: 'wrap', gap: 10 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
              <LogoMark size={36} />
              <div>
                <div style={{ ...BF, fontSize: 9, letterSpacing: '2.5px', textTransform: 'uppercase', color: '#7A7A7A', fontWeight: 600 }}>Client {code}</div>
                <div style={{ fontSize: 20, fontWeight: 400, letterSpacing: '-0.01em', fontStyle: 'italic' }}>Today's Plan</div>
              </div>
            </div>
            <button onClick={() => { if (window.confirm(`Switch from ${PHASES[phase].label}? Your current plan will reset.`)) { setPhase(null); setPlan([]); setGoalsSet(false); setMacrosUnknown(false); } }} style={{ ...BF, padding: '6px 12px', fontSize: 10, fontWeight: 700, letterSpacing: '1.5px', textTransform: 'uppercase', background: K, color: G, border: 'none', borderRadius: 20, cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 5 }}><PIcon size={11} /> {PHASES[phase].label}</button>
          </div>
          {macrosUnknown ? (
            <div style={{ ...BF, fontSize: 12, color: '#7A7A7A', padding: '10px 14px', background: '#FFF', border: `1px solid ${LINE}`, fontStyle: 'italic' }}>Macros not set yet — Corey will confirm your targets on your 1:1 call. Explore and save meals you enjoy!</div>
          ) : (
      ...
      <div style={wrap}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 24, flexWrap: 'wrap' }}>
          ...
          <div style={{ ...BF, display: 'inline-flex', alignItems: 'center', gap: 5, fontSize: 10, letterSpacing: '2px', textTransform: 'uppercase', color: '#7A7A7A', fontWeight: 700, marginLeft: 8 }}><Clock size={11} /> Cook Time</div>
          {[{ label: '5 min', val: 5 }, { label: '15 min', val: 15 }, { label: '30 min', val: 30 }].map(opt => {
            const a = cookFilter === opt.val;
            return <button key={opt.val} onClick={() => setCookFilter(a ? null : opt.val)} style={{ ...BF, padding: '6px 14px', fontSize: 11, fontWeight: 600, background: a ? K : 'transparent', color: a ? G : K, border: `1px solid ${a ? K : '#D4CFBF'}`, borderRadius: 20, cursor: 'pointer' }}>{opt.label} or less</button>;
          })}
        </div>
              ...
              {visible.map(m => {
                ...
                return (
                  <div key={m.id} className="mc" style={{ background: '#FFF', border: `1px solid ${LINE}`, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                    <div style={{ width: '100%', height: 160, overflow: 'hidden', background: '#1a1a1a', position: 'relative' }}>
                      <img src={m.img} alt={m.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} loading="lazy" />
                      <div className="ing-tooltip">
                        <div style={{ ...BF, fontSize: 9, letterSpacing: '2px', textTransform: 'uppercase', color: G, fontWeight: 700, marginBottom: 7 }}>Ingredients</div>
                        {m.ing.map(([item, amt, unit], i) => (
                          <div key={i} style={{ ...BF, fontSize: 11, color: '#FAFAF7', lineHeight: 1.55, display: 'flex', gap: 6 }}>
                            <span style={{ color: G, fontWeight: 700, flexShrink: 0 }}>{fmtAmt(amt, unit)}{fmtUnit(unit)}</span>
                            <span style={{ opacity: 0.9 }}>{item}</span>
                          </div>
                        ))}
                      </div>
                      <div style={{ position: 'absolute', bottom: 8, right: 8, ...BF, fontSize: 10, fontWeight: 700, background: 'rgba(10,10,10,0.72)', color: G, padding: '3px 8px', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                        <Clock size={9} /> {m.cookMins} min
                      </div>
                    </div>
          ...
          <div>
            <div style={{ position: 'sticky', top: 180, background: '#FFF', border: `1px solid ${LINE}`, overflow: 'hidden' }}>
                ...
                {planMeals.map(m => (
                  <div key={m.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', padding: '10px 0', borderBottom: '1px solid #F0EBDC' }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ ...BF, fontSize: 12, fontWeight: 600, color: K, marginBottom: 2 }}>{m.name}{m.qty > 1 && <span style={{ color: G, marginLeft: 6, fontWeight: 700 }}>x{m.qty}</span>}</div>
                      <div style={{ ...BF, fontSize: 10, color: '#7A7A7A' }}>{m.cal * m.qty} cal · {m.p * m.qty}g P · {m.c * m.qty}g C · {m.f * m.qty}g F</div>
                    </div>
              ...
              <div style={{ padding: '16px 20px', background: BG, borderTop: `1px solid ${LINE}` }}>
                {plan.length > 0 && !onTrack && !macrosUnknown && (
...
function Review({ meal, existing, onSubmit, onCancel, clientCode }) {
  ...
  const Stars = ({ v, on, l }) => (
    <div style={{ marginBottom: 20 }}>
      <div style={{ ...BF2, fontSize: 11, letterSpacing: '1.5px', textTransform: 'uppercase', color: K2, fontWeight: 600, marginBottom: 8 }}>{l}</div>
      <div style={{ display: 'flex', gap: 6 }}>
        {[1, 2, 3, 4, 5].map(n => <button key={n} onClick={() => on(n)} style={{ background: 'transparent', border: 'none', cursor: 'pointer', padding: 2 }}><Star size={26} color={G2} fill={n <= v ? G2 : 'none'} strokeWidth={1.5} /></button>)}
      </div>
    </div>
  );
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG2, fontFamily: '"Fraunces", Georgia, serif', padding: '40px 20px' }}>
      ...
      <div style={{ maxWidth: 600, margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 32 }}><div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: 22, letterSpacing: '7px', color: G2, fontWeight: 600, textTransform: 'uppercase' }}>CORZNAFFECT</div></div>
        <div style={{ background: '#FFF', border: `1px solid ${LINE2}`, padding: '40px 36px', position: 'relative', overflow: 'hidden' }}>
          <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 3, background: `linear-gradient(90deg, transparent, ${G2}, transparent)` }} />
          <button onClick={onCancel} style={{ background: 'transparent', border: 'none', cursor: 'pointer', color: '#7A7A7A', padding: '4px 0', display: 'inline-flex', alignItems: 'center', gap: 4, ...BF2, fontSize: 12, marginBottom: 20 }}><ArrowLeft size={14} /> Back to plan</button>
          <div style={{ ...BF2, fontSize: 11, letterSpacing: '3px', textTransform: 'uppercase', color: G2, fontWeight: 700, marginBottom: 8 }}>Cooked &amp; Reviewed</div>
          <h1 style={{ fontSize: 30, fontWeight: 400, margin: '0 0 6px', letterSpacing: '-0.02em', lineHeight: 1.1, fontStyle: 'italic' }}>{meal.name}</h1>
          <p style={{ ...BF2, fontSize: 13, color: '#5A5A5A', margin: '0 0 28px', lineHeight: 1.6 }}>Help other clients (and your coach) understand what worked. Reviews may be used as testimonials.</p>
          ...
          <div style={{ marginBottom: 20 }}>
            <div style={{ ...BF2, fontSize: 11, letterSpacing: '1.5px', textTransform: 'uppercase', color: K2, fontWeight: 600, marginBottom: 8 }}>Your thoughts</div>
            <textarea value={c} onChange={e => setC(e.target.value)} placeholder="What did you love? Any tweaks? Would you cook it again?" rows={4} style={{ ...BF2, width: '100%', padding: '12px 14px', fontSize: 14, border: '1px solid #D4CFBF', background: BG2, resize: 'vertical', lineHeight: 1.5 }} />
          </div>
          <div style={{ marginBottom: 28 }}>
            <div style={{ ...BF2, fontSize: 11, letterSpacing: '1.5px', textTransform: 'uppercase', color: K2, fontWeight: 600, marginBottom: 8 }}>Add a photo (optional)</div>
            {ph ? (
              ...
              <label style={{ ...BF2, display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 20px', fontSize: 12, fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', background: BG2, color: K2, border: `1px dashed ${G2}`, cursor: 'pointer' }}>
                <Camera size={14} color={G2} /> Upload your dish photo
