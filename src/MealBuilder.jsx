...
const IMG = {
  ...
  eggs: 'https://images.pexels.com/photos/29893443/pexels-photo-29893443.jpeg?w=600&q=80',
  ...
  protbar: 'https://images.pexels.com/photos/14513406/pexels-photo-14513406.jpeg?w=600&q=80',
  ...
  jerky: 'https://images.unsplash.com/photo-1652209695374-7a91c243f12f?w=600&q=80',
...
const MEALS = [
  ...
  { id: 'b3', name: 'Scrambled Eggs on Sourdough', cat: 'breakfast', img: IMG.eggs, cal: 560, p: 35, c: 40, f: 28, cookMins: 10, tags: ['vego'], scale: true, ing: [['Coles Free Range Eggs', 3, 'large'], ['Bakers Delight Sourdough', 2, 'slices'], ['Western Star Salted Butter', 10, 'g'], ['Pura Light Milk', 30, 'ml'], ['Bega Tasty Cheese', 25, 'g'], ['Tomato', 1, 'medium']], steps: ['Whisk eggs with milk, salt and pepper.', 'Melt butter in a non-stick pan over medium-low heat.', 'Pour in eggs, stir gently, removing while still slightly wet.', 'Add cheese and fold through off the heat until melted.', 'Toast sourdough. Slice tomato. Plate eggs over toast with tomato on the side.'] },
